...
GLAPI void APIENTRY GLAPI_PREFIX(FlushMappedBufferRangeEXT)(GLenum target, GLintptr offset, GLsizeiptr length);
GLAPI GLvoid * APIENTRY GLAPI_PREFIX(MapBufferRange)(GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access);
GLAPI GLvoid * APIENTRY GLAPI_PREFIX(MapBufferRangeEXT)(GLenum target, GLintptr offset, GLsizeiptr size, GLbitfield length);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_726)(GLuint id, GLenum pname, GLint64 *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_727)(GLuint id, GLenum pname, GLuint64 *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_728)(GLuint id, GLenum target);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_815)(GLenum target, GLenum internalformat, GLenum pname, GLsizei bufSize, GLint *params);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_829)(GLfloat x, GLfloat y, GLfloat z, GLfloat width, GLfloat height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_830)(const GLfloat *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_831)(GLint x, GLint y, GLint z, GLint width, GLint height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_832)(const GLint *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_833)(GLshort x, GLshort y, GLshort z, GLshort width, GLshort height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_834)(const GLshort *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_835)(GLfixed x, GLfixed y, GLfixed z, GLfixed width, GLfixed height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_836)(const GLfixed *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_837)(GLenum type, GLsizei stride, const GLvoid *pointer);
GLbitfield APIENTRY GLAPI_PREFIX(_dispatch_stub_838)(GLfixed *mantissa, GLint *exponent);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_839)(GLclampf value, GLboolean invert);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_840)(GLenum pattern);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_863)(const GLenum *mode, const GLint *first, const GLsizei *count, GLsizei primcount, GLint modestride);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_864)(const GLenum *mode, const GLsizei *count, GLenum type, const GLvoid * const *indices, GLsizei primcount, GLint modestride);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_938)(GLenum face);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_939)(GLuint array);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_948)(GLenum coord, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_949)(GLenum coord, GLenum pname, GLint param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_950)(GLenum coord, GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_951)(GLclampd zmin, GLclampd zmax);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_952)(GLenum target, GLenum pname, GLint param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_953)(GLenum target, GLintptr offset, GLsizeiptr size);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_978)(GLenum frontfunc, GLenum backfunc, GLint ref, GLuint mask);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_979)(GLenum target, GLuint index, GLsizei count, const GLfloat *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_980)(GLenum target, GLuint index, GLsizei count, const GLfloat *params);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_983)(GLenum func, GLclampx ref);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_984)(GLclampx red, GLclampx green, GLclampx blue, GLclampx alpha);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_985)(GLclampx depth);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_986)(GLfixed red, GLfixed green, GLfixed blue, GLfixed alpha);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_987)(GLclampx zNear, GLclampx zFar);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_988)(GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_989)(GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_990)(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat zNear, GLfloat zFar);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_991)(GLfixed left, GLfixed right, GLfixed bottom, GLfixed top, GLfixed zNear, GLfixed zFar);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_992)(GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_993)(GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_994)(GLenum light, GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_995)(GLenum light, GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_996)(GLfixed width);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_997)(const GLfixed *m);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_998)(GLenum face, GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_999)(GLenum face, GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1000)(const GLfixed *m);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1001)(GLenum target, GLfixed s, GLfixed t, GLfixed r, GLfixed q);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1002)(GLfixed nx, GLfixed ny, GLfixed nz);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1003)(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat zNear, GLfloat zFar);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1004)(GLfixed left, GLfixed right, GLfixed bottom, GLfixed top, GLfixed zNear, GLfixed zFar);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1005)(GLfixed size);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1006)(GLfixed factor, GLfixed units);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1007)(GLfixed angle, GLfixed x, GLfixed y, GLfixed z);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1008)(GLclampx value, GLboolean invert);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1009)(GLfixed x, GLfixed y, GLfixed z);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1010)(GLenum target, GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1011)(GLenum target, GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1012)(GLenum target, GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1013)(GLfixed x, GLfixed y, GLfixed z);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1014)(GLenum plane, const GLfloat *equation);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1015)(GLenum plane, const GLfixed *equation);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1016)(GLenum plane, GLfloat *equation);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1017)(GLenum plane, GLfixed *equation);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1018)(GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1019)(GLenum light, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1020)(GLenum face, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1021)(GLenum target, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1022)(GLenum target, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1023)(GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1024)(GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1025)(GLenum target, GLenum pname, const GLfixed *params);
...
".set "GLAPI_PREFIX_STR(DrawBuffersNV)", "GLAPI_PREFIX_STR(DrawBuffers)"\n"
...
".globl "GLAPI_PREFIX_STR(FlushMappedBufferRangeEXT)"\n"
".set "GLAPI_PREFIX_STR(FlushMappedBufferRangeEXT)", "GLAPI_PREFIX_STR(FlushMappedBufferRange)"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(MapBufferRange))"\n"
"\t"STUB_ASM_CODE("681")"\n"

".globl "GLAPI_PREFIX_STR(MapBufferRangeEXT)"\n"
".set "GLAPI_PREFIX_STR(MapBufferRangeEXT)", "GLAPI_PREFIX_STR(MapBufferRange)"\n"
...
".globl "GLAPI_PREFIX_STR(DeleteVertexArraysOES)"\n"
".set "GLAPI_PREFIX_STR(DeleteVertexArraysOES)", "GLAPI_PREFIX_STR(DeleteVertexArrays)"\n"
...
".globl "GLAPI_PREFIX_STR(IsVertexArrayOES)"\n"
".set "GLAPI_PREFIX_STR(IsVertexArrayOES)", "GLAPI_PREFIX_STR(IsVertexArray)"\n"
